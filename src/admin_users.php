...
while ($data = mysqli_fetch_array($users)) {
	...
	<tr class="userList">
		...
		<td><?php echo ($data['desactivated'] ? "Desactivé" : "Activé"); ?></td>
		...
		<td><a href='admin_users.php?activ_id=<?php echo $data['id']; ?>'><?php echo ($data['desactivated'] ? "Activer" : "Desactiver"); ?></a></td>
	</tr>
	<?PHP
} ?>
</table>
